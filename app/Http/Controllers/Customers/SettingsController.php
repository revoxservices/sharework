...
class SettingsController extends Controller
{
    ...
    public function __construct(UserRepository $userRepo, UploadRepository $uploadRepo,
    ...
    public function index()
    {
        ...
        return view('customers.views.settings.index')->with("customFields", isset($html) ? $html : false)->with("user", $user);
    }
