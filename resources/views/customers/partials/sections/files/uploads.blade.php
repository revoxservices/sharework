    ...
    <div class="nk-block-head-xs">
        <div class="nk-block-between g-2">
            <div class="nk-block-head-content">
                <h6 class="nk-block-title title">Mis archivos</h6>
            </div>
            <div class="nk-block-head-content">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="link-list-plain no-bdr">
                                        ...
                                        <li><a class="file-share" data-toggle="modal" data-id="{{ $item->upload->id }}"><em class="icon ni ni-share"></em><span>Compartir</span></a></li>
