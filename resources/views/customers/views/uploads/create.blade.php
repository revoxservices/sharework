                ...
                <div class="nk-block-head nk-block-head-lg">
                    ...
                    <div class="nk-block-head-content">
                        ...
                        <div class="nk-block-des">
                            <p>Puede encontrar todas la informacion para editar un integrante que tienes creado en tu cuenta.</p>
                        </div>
                    </div>
                </div><!-- .nk-block-head -->
                <div class="nk-block mb-3">
                    <div class="card card-bordered">
                        <div class="card-inner">
                            {!! Form::open(['route' => ['customers.shares.store'], 'method' =>'POST', 'class' =>'gy-3', 'files' => true]) !!}
                                   
                                <input id="project" name="project" type="hidden" value="{{ $project->id }}">
                                <input id="upload" name="upload" type="hidden" value="{{ $upload->id }}">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    {!! Form::select('user', $users , null , ['id' => 'users' , 'data-search' => 'on' , 'class' => 'form-select form-control form-control-lg']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3 align-center">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    {!! Form::select('privilege', $privileges , null , ['id' => 'privileges' , 'data-search' => 'on' , 'class' => 'form-select form-control form-control-lg']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
