        ...
        <div class="nk-content-body">
            <div class="nk-content-wrap">
                <div class="nk-block-head nk-block-head-lg">
                    <div class="nk-block-head-sub"><a href="support.html" class="text-soft"><span>Edición</span></a></div>
                ...
                <div class="nk-block mb-3">
                    <div class="card card-bordered">
                        <div class="card-inner">
                            ...
                            {!! Form::open(['route' => ['customers.projects.update'], 'method' =>'POST', 'class' =>'gy-3', 'files' => true ,'enctype'=>'multipart/form-data']) !!}
                            
                            <input id="prodId" name="token" type="hidden" value="{{ $project->token }}">
                            ...
                            <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                {!! Form::text('title', $project->title,  ['class' => 'form-control form-control-lg','placeholder'=> 'Write your problem...' ]) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                {!! Form::text('subtitle', $project->subtitle,  ['class' => 'form-control form-control-lg','placeholder'=> 'Write your problem...' ]) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-7">
                                        <ul class="custom-control-group g-3 align-center flex-wrap">
                                            ...
                                            @else
                                                <li>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input"  name="status" id="status-enable">
                                                        <label class="custom-control-label" for="status-enable">Habilitado</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input" checked="" name="status" id="status-disable">
                                                        <label class="custom-control-label" for="status-disable">Inabilitado</label>
                                                    </div>
                                                </li>
                                            @endif
                                ...
                                <div class="row g-3 align-center">
                                    ...
                                    <div class="col-lg-7">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <textarea class="form-control form-control-lg no-resize" name="description" placeholder="..."> {{ $project->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
