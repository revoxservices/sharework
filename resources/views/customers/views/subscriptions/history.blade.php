                ...
                <div class="nk-content-body">
                    <div class="nk-content-wrap">
                        <div class="nk-block-head nk-block-head-lg">
                            <div class="nk-block-head-sub"><span>Administrador Suscripción</span></div>
                            <div class="nk-block-between-md g-4">
                                <div class="nk-block-head-content">
                                    <h2 class="nk-block-title fw-normal">Mi Suscripción</h2>
                                    <div class="nk-block-des">
                                        <p>Aquí hay una lista del paquete / producto al que se ha suscrito. <span class="text-primary"><em class="icon ni ni-info"></em></span></p>
                                    </div>
                                </div>
                                <div class="nk-block-head-content">
                                    <ul class="nk-block-tools gx-3">
                                        <li class="order-md-last">
                                            <a href="{{ route('customers.subscriptions.plans') }}"  class="btn btn-primary" ><span>Ver Planes</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="row gx-0 gy-3">
                                                    <div class="col-xl-9 col-sm-8">
                                                        <div class="sp-plan-name">
                                                            ...
                                                            <p>Subscripción ID: <span class="text-base">{{ $sub->id }}</span></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- .sp-plan-info -->
                                            <div class="sp-plan-desc card-inner">
                                                <ul class="row gx-1">
                                                    <li class="col-6 col-lg-6">
                                                        <p><span class="text-soft">Fecha creación</span> {{ $sub->created_at }}</p>
                                                    </li>
                                                    <li class="col-6 col-lg-6">
                                                        <p><span class="text-soft">Capacidad</span>{{ $sub->plan->size/1024 }} GB</p>
                                                    </li>
                                                </ul>
                                            </div><!-- .sp-plan-desc -->
                                        </div><!-- .col -->
                                        <div class="col-md-4">
                                            <div class="sp-plan-action card-inner">
                                                <div class="sp-plan-btn">
                                                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#subscription-change">
