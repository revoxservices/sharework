                ...
                <div class="nk-content-body">
                    <div class="nk-content-wrap">
                        <div class="nk-block-head nk-block-head-lg">
                            <div class="nk-block-head-sub"><span>Planes</span></div>
                            <div class="nk-block-between-md g-4">
                                <div class="nk-block-head-content">
                                    <h2 class="nk-block-title fw-normal">Elija el plan adecuado</h2>
                                    <div class="nk-block-des">
                                        <p>Puede cambiar su plan en cualquier momento actualizando su plan</p>
                                    </div>
                                </div>
                            </div>
                        </div><!-- .nk-block-head -->
                                ...
                                @foreach ($plans as $plan)
                                    @if($sub!=null)
                                        @if ($sub->plan_id == $plan->id)
                                            <div class="col-md-4">
                                                <div class="price-plan card card-bordered text-center plan-select">
                                                    <div class="card-inner">
                                                        ...
                                                        <div class="price-plan-amount">
                                                            <div class="amount">$ {{ (int)$plan->size/1024 }} <span>/GB</span></div>
                                                        </div>
                                                    </div>
                                                </div><!-- .price-item -->
                                            </div><!-- .col -->
                                            ...
                                            <div class="price-plan card card-bordered text-center">
                                                <div class="card-inner">
                                                    ...
                                                    <div class="price-plan-action">
                                                        <a  class="btn btn-primary add-plan" data-id="{{ $plan->id }}">Seleccionar</a>
                                                    </div>
                                                </div>
                                            </div><!-- .price-item -->
                                        </div><!-- .col -->
...
<script  type="text/javascript">
   ...
   $(document).ready(function() {
     ...
     function addPlan(plan) {
            ...
            $.ajax({
               url: '/customers/subscriptions/store',
               type: "POST",
               datatype: "html",
               data: {
