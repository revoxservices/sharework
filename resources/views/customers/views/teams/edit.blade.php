                ...
                <div class="nk-block mb-3">
                    <div class="card card-bordered">
                        <div class="card-inner">
                            ...
                            {!! Form::open(['route' => ['customers.teams.update'], 'method' =>'POST', 'class' =>'gy-3', 'files' => true ,'enctype'=>'multipart/form-data']) !!}
                                  
                                <input id="project" name="team" type="hidden" value="{{ $team->id }}">
                                <input id="project" name="project" type="hidden" value="{{ $project->token }}">
